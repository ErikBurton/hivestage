export const UTAH_CITIES = [
  ...
  'Park City', 'Payson', 'Pleasant Grove', 'Provo', 'Richfield', 'Riverton',
  'Roy', 'Salt Lake City', 'Sandy', 'Saratoga Springs', 'South Jordan',
  'South Salt Lake', 'Spanish Fork', 'Springville', 'St. George', 'Taylorsville',
