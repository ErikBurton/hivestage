  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-2xl mx-auto p-8">
        <a href="/venues" className="text-gray-500 text-sm hover:text-yellow-400 mb-6 inline-block">← Back to venues</a>
        ...
        <div className="bg-gray-900 rounded-2xl p-8 mb-6">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              {venue.capacity && <p className="text-gray-500 text-sm mt-1">Capacity: {venue.capacity.toLocaleString()}</p>}
            </div>
          </div>
          {venue.profiles?.bio && (
          ...
          <div className="flex gap-4 mt-6">
            {venue.profiles?.website && (
              <a href={venue.profiles.website} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:underline text-sm">Website →</a>
            )}
            {venue.profiles?.instagram && (
              <a href={`https://instagram.com/${venue.profiles.instagram}`} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:underline text-sm">@{venue.profiles.instagram}</a>
            )}
          </div>
        </div>
