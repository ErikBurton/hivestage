    ...
    <main className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="max-w-3xl mx-auto p-8">
        ...
        <div className="bg-gray-900 rounded-2xl p-4 mb-6 flex flex-wrap gap-3 items-center">
          <input
            className="flex-1 min-w-45 px-3 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-500 border border-gray-700 focus:outline-none focus:border-yellow-400 text-sm"
